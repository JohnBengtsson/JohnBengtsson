...
-- Tokens are encrypted at rest. Only the service role key can write.
-- anon users can read their own connection status (to show connected/disconnected UI)
-- but cannot write tokens directly.
